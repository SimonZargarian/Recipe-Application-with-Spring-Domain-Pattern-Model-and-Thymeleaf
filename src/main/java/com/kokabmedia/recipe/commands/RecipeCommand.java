...
public class RecipeCommand {
    ...
    @Size(min = 3, max = 255) // Minimun size of characters has to be three
    private String description;

    @Min(1) // Minimum size of characters can be 1
    @Max(999) // Maximum size of characters can be 999
